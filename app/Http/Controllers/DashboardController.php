...
class DashboardController extends Controller
{
    ...
    public function search(Request $request) {
		...
		$data['pariwisata'] = Pariwisata::where('judul','like',"%".$search."%")->paginate(6);
    ...
    public function spotmar() {
        $data['subtitle'] = "Spotmar-Kasal";
        return view('dashboard.spotmar-kasal',$data);
    }

    public function dispotmar() {
        $data['subtitle'] = "Dispotmar";
        return view('dashboard.dispotmar',$data);
    }

     public function koarmada1() {
        $data['subtitle'] = "koarmada1";
        return view('dashboard.koarmada1',$data);
    }
     public function koarmada2() {
        $data['subtitle'] = "koarmada2";
        return view('dashboard.koarmada2',$data);
    }
     public function koarmada3() {
        $data['subtitle'] = "koarmada3";
        return view('dashboard.koarmada3',$data);
    }

    public function pariwisata() {
        $data['pariwisata'] = Pariwisata::with('user')->paginate(6);
        return view('dashboard.pariwisata',$data);
    }

     public function detail_pariwisata($id) 
    {
        // $data['product'] = Product_user::with('user')->select('product_users','id');
        $data['subtitle'] = "Detail Pariwisata";
        $data['pariwisata'] =  Pariwisata::with('user')
                            ->where('id',$id)->get();
        return view('dashboard.detail-pariwisata',$data); 
    }
