                ...
                <div class="card">
                  ...
                  <input name="user_id" type="hidden" value="">
                    <div class="form-group">
                      <label>Judul</label>
                      <input type="text" name="judul" class="form-control" placeholder="Judul" required value="{{ $berita->judul}}">
                      @error('judul')
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="desk" required >{{ $berita->desk}}</textarea>
                       @error('desk')
                        <div class="text-danger">
                          {{ $message }}
                        </div>
