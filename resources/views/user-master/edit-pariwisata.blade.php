                  ...
                  <input name="user_id" type="hidden" value="">
                    ...
                    <label>Deskripsi</label>
                        <div class="input-group mb-3">
                            <textarea class="form-control" rows="3" name="deskripsi" placeholder="Deskripsi" required>{{ $pariwisata->deskripsi}}</textarea>
                        @error('deskripsi')
                            <div class="text-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                      <label>Alamat</label>
                      <textarea class="form-control" rows="3" name="alamat" placeholder="alamat" required>{{ $pariwisata->alamat}} </textarea>
                      @error('alamat')
                            <div class="text-danger">
                                {{ $message }}
                            </div>
                    ...
                    <label>Harga Tiket Masuk</label>
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control" name="htm" placeholder="Harga" aria-label="Username" aria-describedby="basic-addon1"  value="{{ $pariwisata->htm}}">
                        </div>
                        @error('htm')
                            <div class="text-danger">
                                {{ $message }}
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="fasilitas" required >{{ $pariwisata->fasilitas}}</textarea>
                       @error('fasilitas')
                        <div class="text-danger">
                          {{ $message }}
                        </div>
